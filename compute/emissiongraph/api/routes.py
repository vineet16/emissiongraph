...
async def query_llm(req: QueryRequest):
    ...
    system = (
        ...
        "## HARD RULES\n\n"
        "- State only what the data shows: quantities consumed, emission contributions, "
        "and their relative magnitudes.\n"
        "- Do NOT speculate about operational causes, equipment types, practices, or reasons "
        "behind observed patterns. No 'suggests', 'likely', 'probably', or 'this indicates'.\n"
        "- Do NOT add causal claims the data does not contain.\n"
        "- If the data shows renewable MWH, you may state that. If it does not, do not guess.\n\n"
        "## How to analyze\n\n"
        ...
        "2. DESCRIBE WHAT THE DATA SHOWS: State the dominant emission source by its share of "
        "total intensity. 'P8 emissions are 99.99% Scope 2 electricity with diesel contributing "
        "0.01%' is a factual observation. 'P8 has electrified its operations' is speculation.\n"
        ...
        "4. DISCLOSE DATA-BACKED FACTS: If renewable MWH data is present, state it. "
        "If a source is absent for a port (zero), state it is zero — do not explain why.\n"
        "5. BE SPECIFIC: Use exact numbers and percentages. Full stop after the facts.\n\n"
